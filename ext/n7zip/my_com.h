...
#ifndef __N7ZIP_MY_COM_H
#define __N7ZIP_MY_COM_H
...
inline HRESULT
StringToBstr(LPCOLESTR src, BSTR* bstr)
{
...
#define MY_QUERYINTERFACE_ENTRY(i) \
  else if (iid == IID_##i) { *outObject = (void*)(i*)this; }

#define MY_QUERYINTERFACE_ENTRY_UNKNOWN(i)   \
  if (iid == IID_IUnknown) {                 \
...
#define MY_UNKNOWN_IMP_SPEC(i) \
  MY_QUERYINTERFACE_BEGIN      \
  i MY_QUERYINTERFACE_END MY_ADDREF_RELEASE
